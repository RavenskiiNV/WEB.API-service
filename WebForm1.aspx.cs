        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            else if (GridView2.Visible == true)
            {
                ...
                if (txt_DataSource.Text != "" && txt_Initial_Catalog.Text != "")
                {
                    try
                    {
                        WCF_SENDING_TO_SALES(txt_DataSource.Text.ToString(), txt_Initial_Catalog.Text.ToString(), txt1, txt2, txt2, txt4, txt5, txt6);
            ...
            else if (GridView3.Visible == true)
            {
                ...
                if (txt_DataSource.Text != "" && txt_Initial_Catalog.Text != "")
                {
                    try
                    {
                        WCF_SENDING_TO_RETURNS(txt_DataSource.Text.ToString(), txt_Initial_Catalog.Text.ToString(), txt1, txt2, txt2, txt4, txt5, txt6);
