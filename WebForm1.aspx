...
<body>
    <form id="form1" runat="server">
       ...
       <div>
            <asp:FileUpload ID="FileUpload1" runat="server" style="position:absolute; top: 12%; right: 1px"/>
        </div>
        ...
        <asp:Button ID="Button5" CssClass="btn-new" runat="server" Text="Назад" Height="40px" Width="84px" OnClick="Button5_Click" />
        ...
        <asp:Panel ID="Panel3" CssClass="text_r" Width="250px" runat="server">
            ...
            <asp:Label ID="Label18" runat="server" Text="Код товара" Font-Bold="True"></asp:Label>
